    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {activeTab === "analytics" ? (
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    These are sample analytics to demonstrate the visualization capabilities. Upload your Excel file in the "Upload Excel" tab to generate real insights from your data with AI-powered analysis.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="space-y-6">
            {/* Upload Box */}
            <div className="bg-white rounded-2xl shadow-lg p-10 border-2 border-gray-100 hover:shadow-xl transition-shadow">
              <div className="border-2 border-dashed border-gray-300 rounded-2xl p-12 flex flex-col items-center justify-center text-center hover:border-[#c7243b] hover:bg-gray-50/50 transition-all duration-300 group">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform border-2 border-blue-200">
              ...
              {file && (
                <div className="mt-6 flex justify-center">
                  <button
                    ...
                    className="px-8 py-3 bg-gradient-to-r from-green-600 to-green-500 text-white rounded-xl font-semibold hover:shadow-lg hover:scale-105 transition-all duration-300"
                  >
                    ⬆️ Upload File
                  </button>
                </div>
